...
class SaveReminderViewModel(val app: Application, private val dataSource: ReminderDataSource) :
    ...
    fun setPointOfInterest(selectedPoint: PointOfInterest) {

        _selectedPOI.value = selectedPoint
        _latitude.value = selectedPoint.latLng.latitude
        _longitude.value = selectedPoint.latLng.longitude
        _reminderSelectedLocationStr.value = selectedPoint.name
    }
